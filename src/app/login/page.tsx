        ...
        <div className="text-center mb-6">
          <div className="mx-auto h-16 w-16 rounded-full bg-vacacional-agua flex items-center justify-center transform transition-transform duration-300 hover:scale-110">
            <svg
              ...
              className="h-8 w-8 text-vacacional-salvia"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-vacacional-menta focus:ring-vacacional-agua border-vacacional-gris-verde rounded transition-colors duration-200"
              />
